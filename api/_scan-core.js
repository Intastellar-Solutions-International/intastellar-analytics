...
export const TRACKERS = [
    ...
    { domains: ["seora.dk"],                                     service: "Seora",                    category: "analytics"    },
...
export const VENDOR_META = {
    ...
    "Seora":              { description: "AI-powered marketing automation platform trained on your own content", privacyUrl: "https://seora.dk/privatliv", legalBasis: "consent", transferMechanism: "EEA" },
...
export const COOKIE_VENDOR_HINTS = [
    ...
    { exact:  "PREF",              service: "YouTube"             },
    { exact:  "YSC",               service: "YouTube"             },
    { exact:  "VISITOR_INFO1_LIVE", service: "YouTube"            },
    { exact:  "VISITOR_PRIVACY_METADATA", service: "YouTube"      },
    { exact:  "GPS",               service: "YouTube"             },
    { prefix: "__Secure-YEC",      service: "YouTube"             },
    ...
    { prefix: "__Secure-3PAPISID", service: "Google"              },
    { prefix: "__Secure-3PSID",    service: "Google"              },
...
export const COOKIE_META = [
    ...
    { prefix: "__Secure-3PAPISID",        description: "Google cross-site API session cookie — identifies signed-in Google users on third-party websites to enable personalised advertising and Google service integration." },
    { prefix: "__Secure-3PSID",           description: "Google cross-site session cookie — identifies signed-in Google users on third-party websites for ad personalisation and cross-site tracking. Blocked by Safari ITP and Firefox ETP." },
